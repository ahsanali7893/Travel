...
import Mountain3 from "../components/Assets/5.jpg";
import Mountain4 from "../components/Assets/8.jpg";
  ...
  return (
    <div className="destination">
      ...
      <DestinationData
        ...
        text="One of the most iconic views in Luzon, Mt Taal baasts a volcano inside a lake inside an island. if you fancy a closer look, the hike up to the crater is a mere 45 minutes, and is easy enough for beginners. Guides will assist you most of the way, and you'll see the peculiar enviroment found on active volcano, including volcanic rocks and stream vents. The hike can be dusty and hot, so plan for and early morning trip, and then unwind with some bulalo before heading back home!"
        img1={Mountain1}
        img2={Mountain2}
      />
